...
Run:  python examples/generate_nonconvex_pathological.py
Output: examples/plots_nonconvex_pathological/NN_name.png
...
OUT = os.path.join(os.path.dirname(__file__), "plots_nonconvex_pathological")
