...
- `generate_features.py` renders 128 additional examples in eight feature families: prescribed continuity, closed distance stations, local move/insert/delete, parameter derivatives, arc-length derivatives, and curvature-vector derivatives.
